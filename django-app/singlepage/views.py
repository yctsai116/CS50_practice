...
def api_response(request):
    ...
    if request.method == "GET":
        ...
        for api_name in request_body:
            req = requests.post(request_body[api_name], data=data["request_body"], headers=data["headers"])
            ...
            sent_requests.append(saved_req.serialize())
